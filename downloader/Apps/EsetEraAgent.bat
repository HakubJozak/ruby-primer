...
rem ===				Set Variables				===
set AppName=EsetEraAgent
echo http://support.eset.com/kb3690 > TMP\%AppName%.get-url
set REGEX_get-string=(?:Windows)(?:.+\n){2}.+(\d.\d.\d{3}.\d)
set REGEX_get-version=(\d.\d.\d{3}.\d)
...
grep -m 1 -oP "%REGEX_get-string%" "TMP\%AppName%.get-ver" 1> TMP\%AppName%.ver-str
...
echo https://download.eset.com/com/eset/apps/business/era/agent/latest/agent_%Architecture%.%Extension% > TMP\%AppName%.dow-url
rem ===============================================
