...
rem ===				Set Variables				===
set AppName=Opera
echo http://www.opera.com/download/guide/?os=windows^&local=y > TMP\%AppName%.get-url
set REGEX_get-string=(?:version=.)(\d{1,2}.\d{1,2}.\d{1,4}.\d{1,2})
...
echo http://get.geo.opera.com/pub/opera/desktop/%version%/win/Opera_%version%_Setup.%Extension% > TMP\%AppName%.dow-url
rem ===============================================
