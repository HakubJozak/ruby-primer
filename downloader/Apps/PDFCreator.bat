...
rem ===				Set Variables				===
set AppName=PDFCreator
echo http://download.pdfforge.org/ > TMP\%AppName%.get-url
set REGEX_get-string=(?:Stable Release )(.+)(?: published on)
...
echo http://download.pdfforge.org/download/pdfcreator/PDFCreator-stable?download > TMP\%AppName%.dow-url
rem ===============================================
