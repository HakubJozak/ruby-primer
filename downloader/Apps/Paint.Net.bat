...
rem ===				Set Variables				===
set AppName=Paint.Net
echo http://www.getpaint.net/download.html > TMP\%AppName%.get-url
set REGEX_get-string=(?:.strong.)(\d{1,2}.\d{1,2}.\d{1,2})
...
echo http://www.dotpdn.com/files/paint.net.%Version%.install.zip > TMP\%AppName%.dow-url
rem ===============================================
